...
function guardarCliente() {
    ...
    // Obtener los platos de la API de JSON-server
    obtenerPlatos();
}
...
function eliminarProducto(id) {
    ...
    // El producto se ha eliminado, por lo que hay que poner las cantidades a 0 en el formulario 
...
function mostrarTotalHTML(subtotal, total, propina) {
    ...
    subtotalParrafo.textContent = 'Total de la cuenta: ';
    ...
    // Eliminar el último resultado para que no se duplique
